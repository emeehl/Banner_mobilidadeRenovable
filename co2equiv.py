...
def axustaUnidades(equivalencias):
    ...
    Devolve:
        ...
        Na mesma orde.
    """
    unidades = [u'kWh', u'kg CO2', u'km eCar', u'árboles/ano']
    miles = [u'MWh', u't CO2', u'miles km', u'miles árboles']
    millons = [u'GWh', u'kt CO2', u'millóns km', u'millóns árbores']
    resultado = []
